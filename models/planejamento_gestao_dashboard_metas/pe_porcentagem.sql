WITH pe_geral AS (
  SELECT
    ...
    -- CASE 
    --   WHEN tendencia_cumprimento_meta_2022 = "Cumprida" or tendencia_cumprimento_meta_2022 = "Tendência de cumprir" then "Cumprir"
...
pe_porcentagem as (
  SELECT
    ...
    tipo_meta,
    casas_decimais,
    ROUND(SAFE_CAST(REPLACE(REPLACE(REPLACE(valor_meta_final, ".", ""), ",", "."), "%", "") AS FLOAT64)/100, casas_decimais) valor_meta_final,
    ano_meta_desdobrada,
    resultado_alcancado_para_2024,
    ROUND(SAFE_CAST(REPLACE(REPLACE(REPLACE(_2021, ".", ""), ",", "."), "%", "") AS FLOAT64)/100, casas_decimais) _2021,
    ROUND(SAFE_CAST(REPLACE(REPLACE(REPLACE(_2022, ".", ""), ",", "."), "%", "") AS FLOAT64)/100, casas_decimais) _2022,
    ROUND(SAFE_CAST(REPLACE(REPLACE(REPLACE(_2023, ".", ""), ",", "."), "%", "") AS FLOAT64)/100, casas_decimais) _2023,
    ROUND(SAFE_CAST(REPLACE(REPLACE(REPLACE(_2024, ".", ""), ",", "."), "%", "") AS FLOAT64)/100, casas_decimais) _2024,
    ROUND(SAFE_CAST(REPLACE(REPLACE(REPLACE(_2025, ".", ""), ",", "."), "%", "") AS FLOAT64)/100, casas_decimais) _2025,
    ...
    ROUND(SAFE_CAST(REPLACE(REPLACE(REPLACE(valor, ".", ""), ",", "."), "%", "") AS FLOAT64)/100, casas_decimais+2) valor,
  FROM pe_valores
  WHERE tipo_meta = 'Percentual'
)

SELECT * FROM pe_porcentagem
