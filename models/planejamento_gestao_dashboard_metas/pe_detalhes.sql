WITH pe_geral AS (
  SELECT
    ...
    -- CASE lembrar de apagar
    --   WHEN LOWER(tendencia_cumprimento_meta_2023) = "cumprida" or              LOWER(tendencia_cumprimento_meta_2023) = "tendência de cumprir" then "Cumprir"
    --   WHEN LOWER(tendencia_cumprimento_meta_2023) = "cumprida parcialmente" or LOWER(tendencia_cumprimento_meta_2023) = "tendência de cumprir parcialmente" then "Cumprir parcialmente"
    --   WHEN LOWER(tendencia_cumprimento_meta_2023) = "não cumprida" or          LOWER(tendencia_cumprimento_meta_2023) = "tendência de não cumprir" then "Não cumprir"
...
SELECT
  ...
  NULL AS codigo_tema,
  NULL AS tema_transversal,
  NULL AS iniciativa_estrategica_nome_de_trabalho,
  NULL AS codigo_meta_desdobrada,
  NULL AS palavras_chave_meta,
  NULL AS codigo_meta,
  NULL AS meta,
  NULL AS orgao_responsavel,
  NULL AS descricao_do_indicador,
  NULL AS unidade_de_medida,
  NULL AS fonte_dos_dados,
  NULL AS frequencia_de_medicao,
  NULL AS formula_de_calculo,
  NULL AS valor_referencia,
  NULL AS data_referencia,
  NULL AS regionalizavel,
  NULL AS _2021,
  NULL AS _2022,
  NULL AS _2023,
  NULL AS _2024,
  NULL AS _2025,
  NULL AS meta_validada_pelo_prefeito,
  ...
  NULL AS meta_alinhada_com_contribuicoes_da_participacao_social,
  NULL AS meta_alinhada_com_meta_do_pds,
  NULL AS palavra_chave_estrategia_pds,
  NULL AS codigo_meta_pds,
  NULL AS se_a_resposta_for_sim_na_coluna_anterior_qual_meta_do_pds,
  NULL AS se_a_resposta_for_alinhada_na_coluna_anterior_mas_com_ponto_de_atencao,
  ...
  NULL AS preenchimento_atualizado_em,
  NULL AS observacoes,
  NULL AS ultimo_resultado,
  NULL AS data_referencia_resultado,
  NULL AS comentarios_da_meta,
  NULL AS resumo_executivo,
  NULL AS tendencia_cumprimento_meta_2021,
  NULL AS tendencia_cumprimento_meta_2022,
  NULL AS tendencia_cumprimento_meta_2023,
  NULL AS tendencia_cumprimento_meta_2024,
  NULL AS final_2021,
  NULL AS final_2022,
  NULL AS final_acumulado_2022,
  NULL AS final_2023,
  NULL AS final_acumulado_2023,
  NULL AS final_2024,
  NULL AS final_acumulado_2024,
  NULL AS chaves_projetos_associados,
  NULL AS nome_dos_projetos,
  NULL AS gerencia_egp_rio,
  NULL AS quantidade_de_indicadores_na_meta,
  NULL AS meta_de_resultado,
  NULL AS medicao_em_2021,
  NULL AS quantidade_de_projetos_associados,
  NULL AS tipo_compromisso,
  NULL AS texto_compromisso,
  NULL AS o_globo,
  NULL AS folha,
  NULL AS texto_o_globo,
  NULL AS descricao_meta_desdobrada,
  NULL AS indicador_dashboard_prefeito,
  NULL AS tipo_meta,
  NULL AS casas_decimais,
  NULL AS valor_meta_final,
  NULL AS ano_meta_desdobrada,
  NULL AS usa_valor_de_referencia_para_calculo_do_resultado_celula_dn,
  NULL AS resultado_alcancado_para_2024,
  NULL AS ordem_da_meta_no_dashboard_do_prefeito,
  NULL AS problemas_encontrados_orientacoes,
  NULL AS andamento_de_projetos_prioritarios_ligados_a_meta_projeto_1,
  NULL AS andamento_de_projetos_prioritarios_ligados_a_meta_projeto_2,
  NULL AS andamento_de_projetos_prioritarios_ligados_a_meta_projeto_3,
  NULL AS andamento_de_projetos_prioritarios_ligados_a_meta_projeto_4,
  NULL AS andamento_de_projetos_prioritarios_ligados_a_meta_projeto_5,
  NULL AS tendencia_numero_pe,
