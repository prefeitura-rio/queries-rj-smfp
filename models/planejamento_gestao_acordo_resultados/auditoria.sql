SELECT
    ...
    SAFE_CAST(SAFE_CAST(data_do_inicio_da_auditoria AS STRING) AS DATE FORMAT 'DD/MM/YYYY') as inicio_auditoria,
    SAFE_CAST(SAFE_CAST(data_do_final_da_auditoria AS STRING) AS DATE FORMAT 'DD/MM/YYYY') as final_auditoria,
    ...
    SAFE_CAST(numero_de_testes AS INT64) as testes,
