SELECT
    ...
    SAFE_CAST(bonificacao_minima_sem_auditoria AS FLOAT64) as bonificacao_minima,
    SAFE_CAST(bonificacao_maxima_sem_auditoria AS FLOAT64) as bonificacao_maxima
